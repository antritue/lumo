...
> Whenever you need to know who has paid and who hasn't, you get a clear, reliable answer instantly. To provide this clarity, Lumo keeps a simple, reliable record of rooms, rent amounts, and payment history — without unnecessary features.
...
All pricing and thresholds are working hypotheses until validated by real usage.
...
- Payment history and reporting (longer timelines)
- Multi-property rollup view
- Gentle payment reminders (if users want them)
