import { CalendarX, FileSpreadsheet, StickyNote, Lightbulb, LucideIcon } from "lucide-react";
        ...
        <Section variant="secondary">
            ...
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="text-lg text-muted-foreground">
                    Lumo is purpose-built for individual property owners. It&apos;s calm, simple, and helps you stay on top of your rentals without the complexity
                </p>
            </div>
        </Section>
    );
